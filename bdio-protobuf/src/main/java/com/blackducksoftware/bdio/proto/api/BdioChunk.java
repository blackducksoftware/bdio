...
public class BdioChunk {
	...
	public BdioChunk(Set<ProtoFileNode> fileNodes, Set<ProtoDependencyNode> dependencyNodes,
			Set<ProtoComponentNode> componentNodes, Set<ProtoAnnotationNode> annotationNodes,
			Set<ProtoImageNode> imageNodes, Set<ProtoImageLayerNode> imageLayerNodes) {
		this.fileNodes = ImmutableSet.copyOf(Objects.requireNonNull(fileNodes));
		...
		this.imageNodes = ImmutableSet.copyOf(Objects.requireNonNull(imageNodes));
		this.imageLayerNodes = ImmutableSet.copyOf(Objects.requireNonNull(imageLayerNodes));
	}
